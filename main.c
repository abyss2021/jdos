...
int jdos_init()
{					
	if(jdos_request_space(jdos_task_sp_frist,JDOS_MAIN_STACK_SIZE)==JDOS_ERR)return JDOS_ERR;	//申请空间
	jdos_task_sp_frist->previous = jdos_task_sp;																						//节点与自身相连
	jdos_task_sp_frist->next = jdos_task_sp;																 								//节点与自身相连
	
	jdos_task_sp->task_entry = main;																													//任务入口
